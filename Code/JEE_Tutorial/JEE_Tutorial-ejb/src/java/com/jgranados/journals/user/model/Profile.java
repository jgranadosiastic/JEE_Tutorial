package com.jgranados.journals.user.model;
...
public class Profile implements Serializable {
	...
	public Profile(Integer idProfile, String firstName, String lastName) {
		this.idProfile = idProfile;
	...
	public String toString() {
		return "com.josegranados.sajavajournals.book.model.Profile[ idProfile=" + idProfile + " ]";
	}
